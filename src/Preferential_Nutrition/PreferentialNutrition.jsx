           ...
           <section className="preferential_Nutrition">
            <div className="preferential_Nutrition_Content">
             <div className="preferential_Nutrition_Content_Container">
                  ...
                  <p>Досягнення ваших фітнес-цілей на 70% залежить від правильного харчування. 
                     Наші експерти розробили програми харчування, які допоможуть досягти максимальних результатів.</p>
                     <div className="preferential_Nutrition_Variant" >
                      {
                       nutrition.map((pref_nutrition, index)=>(
                        <div className="preferential_Nutrition_Variant_Item" key={index} >
                         <div className="preferential_Nutrition_Variant_Item_Img">{pref_nutrition.img}</div>
            ...
            <div className="preferential_Nutrition_Img"> 
               {/* <img src="images/Healthy_food.jpg" alt="Healthy nutrition" style={{width: '700px'}}/> */}
            </div>
           </section>  
