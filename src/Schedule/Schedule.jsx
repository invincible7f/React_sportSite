    ...
    render(){
        ...
        return(
           ...
           <section id="schedule">
            ...
            <>
              <li className="schedul_time" key={index}>{item.time}</li>
            ...
            <>
              <li className="schedul_class" key={index}>{item.class}</li>
             ...
             {schedule.map((item, index) =>(
            <>
              <li className="schedul_trainer" key={index}>{item.trainer}</li>
